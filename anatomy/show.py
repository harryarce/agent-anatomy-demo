...
ORGAN_HIGHLIGHTS = {
    2: OrganHighlight("THE JOB DESCRIPTION", "Define role, priorities, tone, and boundaries.", "Consistent behavior without retraining the model."),
    1: OrganHighlight("THE BRAIN", "Interpret language, reason over ambiguity, and draft responses.", "General intelligence for work that rigid code cannot anticipate."),
    ...
    12: OrganHighlight("EXPERTISE ON DEMAND", "Load specialist guidance only when relevant.", "Reusable expertise without bloating every prompt."),
    5: OrganHighlight("CONTINUITY", "Recall relevant user and task context across sessions.", "Personalization and work that survives a new conversation."),
    6: OrganHighlight("THE BOUNDARIES", "Enforce safety, privacy, and business policy.", "Controls that make growing autonomy governable."),
    7: OrganHighlight("THE TEAM AND PROCESS", "Coordinate steps, specialists, handoffs, and review.", "Repeatable workflows with visible responsibility."),
    8: OrganHighlight("THE BADGE AND KEYS", "Identify the actor and enforce least privilege.", "Accountability and controlled access to business systems."),
    9: OrganHighlight("THE FLIGHT RECORDER", "Trace model calls, tools, latency, tokens, and failures.", "A system operators can explain, debug, and improve."),
    14: OrganHighlight("THE WAKE-UP SIGNAL", "Start governed work from a file, message, or event.", "Proactive behavior without waiting for a chat prompt."),
    15: OrganHighlight("THE ROADMAP", "Break a goal into ordered, measurable sub-goals.", "An inspectable plan before autonomous execution."),
    11: OrganHighlight("THE DURABLE BACKBONE", "Checkpoint progress and resume unfinished work.", "Recovery without repeating completed side effects."),
    10: OrganHighlight("THE BUDGET", "Limit tokens, time, tool calls, and spend.", "Economically predictable autonomy with a hard stop."),
    16: OrganHighlight("THE WORLD MODEL", "Store evidence-backed facts that affect future decisions.", "Explicit, auditable state instead of hidden assumptions."),
    13: OrganHighlight("THE IMPROVEMENT LOOP", "Turn failure evidence into evaluated changes.", "Measured improvement of the agent scaffold under governance."),
}
